					...
					<div class="row">
						<div class="col">
							...
							<div class="contact2_form_container">
								...
								<form action="#" id="contact2_form" class="contact2_form text-center">
									<input type="text" id="contact2_form_name" class="contact2_form_name input_field" placeholder="Nombre" required="required" data-error="Necesitamos tu nombre...">
									<input type="text" id="contact2_form_email" class="contact2_form_email input_field" placeholder="E-mail" required="required" data-error="Necesitamos tu E-mail... ">
									<input type="text" id="contact2_form_subject" class="contact2_form_subject input_field" placeholder="Asunto" required="required" data-error="Necesitamos un asunto...">
									<textarea id="contact2_form_message" class="text_field contact2_form_message" name="message" rows="4" placeholder="Mensage" required="required" data-error="Vaya.. ¿Qué nos querías comentar?"></textarea>
